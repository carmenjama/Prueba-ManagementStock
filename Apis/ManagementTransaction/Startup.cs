...
using ManagementTransaction.Api.Core.Handlers;
using ManagementTransaction.Api.Core.Contexts;
using ManagementTransaction.Api.Core.Formatters;
using Microsoft.AspNetCore.Authorization;
using ManagementTransaction.Api.Core.Settings;
...
namespace ManagementTransaction.Api
{
